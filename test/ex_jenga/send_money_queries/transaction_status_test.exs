defmodule ExJenga.SendMoneyQueries.TransactionStatusTest do
  @moduledoc false

  use ExUnit.Case, async: true

  import Tesla.Mock
  doctest ExJenga.SendMoneyQueries.TransactionStatus

  alias ExJenga.SendMoneyQueries.TransactionStatus
