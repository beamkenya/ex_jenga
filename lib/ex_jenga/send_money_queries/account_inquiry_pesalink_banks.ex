defmodule ExJenga.SendMoneyQueries.AccountInquiryPesalinkBanks do
  @moduledoc """
  ...
  ## Example
      iex> ExJenga.SendMoneyQueries.AccountInquiryPesalinkBanks.request(%{ mobileNumber: "0722000000"})
      {:ok,
        %{
          "banks" => [
